            ...
            <form class="form-inline" action="event.do">
                <div class="form-group">
                    <div class="input-group">
                        <input type="text" class="form-control" placeholder="도서관 및 장소 입력" name="district_event">
                    </div>
                    <div class="input-group">
                        <input style="display: none" type="text" class="form-control" placeholder="도서관명 입력" name="library_event">
                    </div>
